...
class FormElementKeywords(LibraryComponent):
    ...
    def choose_file(self, locator, file_path):
        ...
        points at a file and when using RobotFrameworkSelenium Grid, RobotFrameworkSelenium will
        ...
        to the RobotFrameworkSelenium Grid node where the browser is running.
        Then RobotFrameworkSelenium will send the file path, from the nodes file
    ...
    def input_password(self, locator, password, clear=True):
        ...
        logging from RobotFrameworkSelenium logs is new in SeleniumLibrary 4.2.
        """
    ...
    def input_text(self, locator, text, clear=True):
        ...
        If [https://github.com/SeleniumHQ/selenium/wiki/Grid2|RobotFrameworkSelenium Grid]
        is used and the ``text`` argument points to a file in the file system,
        then this keyword prevents the RobotFrameworkSelenium to transfer the file to the
        RobotFrameworkSelenium Grid hub. Instead, this keyword will send the ``text`` string
        ...
        Disabling the file upload the RobotFrameworkSelenium Grid node and the `clear`
