...
class BrowserManagementKeywords(LibraryComponent):
    ...
    def open_browser(self, url=None, browser='firefox', alias=None,
        ...
        a matching RobotFrameworkSelenium browser driver available. See the
        ...
        and require RobotFrameworkSelenium 3.8.0 or newer.
        ...
        [https://github.com/SeleniumHQ/selenium/wiki/Grid2|RobotFrameworkSelenium Grid].
        ...
        RobotFrameworkSelenium documentation] lists possible capabilities that can be
        enabled.

        Optional ``ff_profile_dir`` is the path to the Firefox profile
        directory if you wish to overwrite the default profile RobotFrameworkSelenium
        ...
        RobotFrameworkSelenium options. Example for Chrome, the ``options`` argument
        ...
        SeleniumLibrary, have RobotFrameworkSelenium options available. Therefore please
        consult the RobotFrameworkSelenium documentation which browsers do support
        the RobotFrameworkSelenium options. If ``browser`` argument is `android` then
        ...
        is used. RobotFrameworkSelenium options are also supported, when ``remote_url``
        argument is used.

        The SeleniumLibrary ``options`` argument accepts RobotFrameworkSelenium
        options in two different formats: as a string and as Python object
        which is an instance of the RobotFrameworkSelenium options class.

        The string format allows defining RobotFrameworkSelenium options methods
        ...
        must match to the RobotFrameworkSelenium options methods and attributes names.
        ...
        the RobotFrameworkSelenium options as Python class instance. In this case, the
        ...
        |  ${options} =  |     Get Options    |        |                                                                                               | # RobotFrameworkSelenium options instance.       |
    ...
    def create_webdriver(self, driver_name, alias=None, kwargs={},
                         **init_kwargs):
        """Creates an instance of RobotFrameworkSelenium WebDriver.
        ...
        RobotFrameworkSelenium API documentation] for details about the supported arguments.
    ...
    def switch_browser(self, index_or_alias):
        ...
        try:
            ...
            raise RuntimeError("No browser with index or alias '%s' found."
                               % index_or_alias)
        self.debug('Switched to browser with RobotFrameworkSelenium session id %s.'
    ...
    def get_selenium_speed(self):
        """Gets the delay that is waited after each RobotFrameworkSelenium command.

        The value is returned as a human-readable string like ``1 second``.

        See the `RobotFrameworkSelenium Speed` section above for more information.
        """
    ...
    def get_selenium_implicit_wait(self):
        """Gets the implicit wait value used by RobotFrameworkSelenium.
    ...
    def set_selenium_speed(self, value):
        """Sets the delay that is waited after each RobotFrameworkSelenium command.
        ...
        Example:
        | `Set RobotFrameworkSelenium Speed` | 0.5 seconds |
        """
    ...
    def set_selenium_timeout(self, value):
        ...
        Example:
        | ${orig timeout} = | `Set RobotFrameworkSelenium Timeout` | 15 seconds |
        | `Open page that loads slowly` |
        | `Set RobotFrameworkSelenium Timeout` | ${orig timeout} |
        """
    ...
    def set_selenium_implicit_wait(self, value):
        """Sets the implicit wait value used by RobotFrameworkSelenium.
        ...
        Example:
        | ${orig wait} = | `Set RobotFrameworkSelenium Implicit Wait` | 10 seconds |
        | `Perform AJAX call that is slow` |
        | `Set RobotFrameworkSelenium Implicit Wait` | ${orig wait} |
        """
    ...
    def set_browser_implicit_wait(self, value):
        ...
        Same as `Set RobotFrameworkSelenium Implicit Wait` but only affects the current
        browser.
        """
